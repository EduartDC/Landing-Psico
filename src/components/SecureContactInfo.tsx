...
import { getContactInfo, createMailtoLink, createWhatsAppLink, createTelLink } from '../utils/contactSecurity';
  ...
  const handleEmailClick = async (e: React.MouseEvent) => {
    ...
    if (contactInfo) {
      const mailtoLink = await createMailtoLink(
        '¡Hola! Me gustaría obtener más información sobre tus servicios de psicología online.',
        'Hola,\n\nMe gustaría obtener más información sobre tus servicios de psicología online.\n\nGracias.'
      );
